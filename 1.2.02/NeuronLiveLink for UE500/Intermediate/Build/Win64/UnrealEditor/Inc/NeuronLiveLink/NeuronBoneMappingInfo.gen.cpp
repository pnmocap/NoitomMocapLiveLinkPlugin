...
class UScriptStruct* FNeuronBoneMappingInfo::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_NeuronBoneMappingInfo.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNeuronBoneMappingInfo, Z_Construct_UPackage__Script_NeuronLiveLink(), TEXT("NeuronBoneMappingInfo"));
	}
...
template<> NEURONLIVELINK_API UScriptStruct* StaticStruct<FNeuronBoneMappingInfo>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_NeuronLiveLink_Source_NeuronLiveLink_Public_NeuronBoneMappingInfo_h_Statics::ScriptStructInfo[] = {
		{ FNeuronBoneMappingInfo::StaticStruct, Z_Construct_UScriptStruct_FNeuronBoneMappingInfo_Statics::NewStructOps, TEXT("NeuronBoneMappingInfo"), &Z_Registration_Info_UScriptStruct_NeuronBoneMappingInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNeuronBoneMappingInfo), 1716915751U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_NeuronLiveLink_Source_NeuronLiveLink_Public_NeuronBoneMappingInfo_h_2721213330(TEXT("/Script/NeuronLiveLink"),
		nullptr, 0,
