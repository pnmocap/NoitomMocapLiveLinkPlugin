...
// End Cross Module References
	...
	DEFINE_FUNCTION(UNeuronLiveLinkBPLibrary::execSetMocapCmdPProgressHandler)
	{
		P_GET_STRUCT_REF(FMocapServerCommand,Z_Param_Out_Cmd);
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		UNeuronLiveLinkBPLibrary::SetMocapCmdPProgressHandler(Z_Param_Out_Cmd,Z_Param_Obj,Z_Param_Function);
		P_NATIVE_END;
	}
	...
	void UNeuronLiveLinkBPLibrary::StaticRegisterNativesUNeuronLiveLinkBPLibrary()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "SetMocapCmdPProgressHandler", &UNeuronLiveLinkBPLibrary::execSetMocapCmdPProgressHandler },
		};
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UNeuronLiveLinkBPLibrary_SendNeuronCommand_Statics::NewProp_Cmd_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UNeuronLiveLinkBPLibrary_SendNeuronCommand_Statics::NewProp_Cmd = { "Cmd", nullptr, (EPropertyFlags)0x0010000008000182, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(NeuronLiveLinkBPLibrary_eventSendNeuronCommand_Parms, Cmd), Z_Construct_UScriptStruct_FMocapServerCommand, METADATA_PARAMS(Z_Construct_UFunction_UNeuronLiveLinkBPLibrary_SendNeuronCommand_Statics::NewProp_Cmd_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UNeuronLiveLinkBPLibrary_SendNeuronCommand_Statics::NewProp_Cmd_MetaData)) };
	...
	struct Z_Construct_UFunction_UNeuronLiveLinkBPLibrary_SetMocapCmdPProgressHandler_Statics
	{
		struct NeuronLiveLinkBPLibrary_eventSetMocapCmdPProgressHandler_Parms
		{
			FMocapServerCommand Cmd;
			UObject* Obj;
			FName Function;
	...
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UFunction_UNeuronLiveLinkBPLibrary_SetMocapCmdPProgressHandler_Statics::NewProp_Function = { "Function", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(NeuronLiveLinkBPLibrary_eventSetMocapCmdPProgressHandler_Parms, Function), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UNeuronLiveLinkBPLibrary_SetMocapCmdPProgressHandler_Statics::NewProp_Obj = { "Obj", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(NeuronLiveLinkBPLibrary_eventSetMocapCmdPProgressHandler_Parms, Obj), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UNeuronLiveLinkBPLibrary_SetMocapCmdPProgressHandler_Statics::NewProp_Cmd = { "Cmd", nullptr, (EPropertyFlags)0x0010000008000180, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(NeuronLiveLinkBPLibrary_eventSetMocapCmdPProgressHandler_Parms, Cmd), Z_Construct_UScriptStruct_FMocapServerCommand, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UNeuronLiveLinkBPLibrary_SetMocapCmdPProgressHandler_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UNeuronLiveLinkBPLibrary_SetMocapCmdPProgressHandler_Statics::NewProp_Function,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UNeuronLiveLinkBPLibrary_SetMocapCmdPProgressHandler_Statics::NewProp_Obj,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UNeuronLiveLinkBPLibrary_SetMocapCmdPProgressHandler_Statics::NewProp_Cmd,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UNeuronLiveLinkBPLibrary_SetMocapCmdPProgressHandler_Statics::Function_MetaDataParams[] = {
		{ "Category", "NeuronLiveLink" },
		{ "ModuleRelativePath", "Public/NeuronLiveLinkBPLibrary.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UNeuronLiveLinkBPLibrary_SetMocapCmdPProgressHandler_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UNeuronLiveLinkBPLibrary, nullptr, "SetMocapCmdPProgressHandler", nullptr, nullptr, sizeof(NeuronLiveLinkBPLibrary_eventSetMocapCmdPProgressHandler_Parms), Z_Construct_UFunction_UNeuronLiveLinkBPLibrary_SetMocapCmdPProgressHandler_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UNeuronLiveLinkBPLibrary_SetMocapCmdPProgressHandler_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04422401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UNeuronLiveLinkBPLibrary_SetMocapCmdPProgressHandler_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UNeuronLiveLinkBPLibrary_SetMocapCmdPProgressHandler_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UNeuronLiveLinkBPLibrary_SetMocapCmdPProgressHandler()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UNeuronLiveLinkBPLibrary_SetMocapCmdPProgressHandler_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UNeuronLiveLinkBPLibrary_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UNeuronLiveLinkBPLibrary_BuildMocapCmdParam, "BuildMocapCmdParam" }, // 3145251461
		{ &Z_Construct_UFunction_UNeuronLiveLinkBPLibrary_BuildMocapCmdParamInt, "BuildMocapCmdParamInt" }, // 3886026223
		{ &Z_Construct_UFunction_UNeuronLiveLinkBPLibrary_BuildMocapCmdParamStopCatpureExtraFlag, "BuildMocapCmdParamStopCatpureExtraFlag" }, // 2587629649
		{ &Z_Construct_UFunction_UNeuronLiveLinkBPLibrary_CreateSource, "CreateSource" }, // 602412611
		{ &Z_Construct_UFunction_UNeuronLiveLinkBPLibrary_GetAvatarNames, "GetAvatarNames" }, // 215913762
		{ &Z_Construct_UFunction_UNeuronLiveLinkBPLibrary_GetNeuronFrameInUE4, "GetNeuronFrameInUE4" }, // 1865509579
		{ &Z_Construct_UFunction_UNeuronLiveLinkBPLibrary_GetNeuronParentJoint, "GetNeuronParentJoint" }, // 825986369
		{ &Z_Construct_UFunction_UNeuronLiveLinkBPLibrary_GetRigidBodyNames, "GetRigidBodyNames" }, // 2901931313
		{ &Z_Construct_UFunction_UNeuronLiveLinkBPLibrary_GetTrackerNames, "GetTrackerNames" }, // 1713685346
		{ &Z_Construct_UFunction_UNeuronLiveLinkBPLibrary_MakeMocapCommand, "MakeMocapCommand" }, // 1441432867
		{ &Z_Construct_UFunction_UNeuronLiveLinkBPLibrary_NeuronBoneIndex, "NeuronBoneIndex" }, // 2269075644
		{ &Z_Construct_UFunction_UNeuronLiveLinkBPLibrary_SendNeuronCommand, "SendNeuronCommand" }, // 2351581288
		{ &Z_Construct_UFunction_UNeuronLiveLinkBPLibrary_SetMocapCmdPProgressHandler, "SetMocapCmdPProgressHandler" }, // 1190035494
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UNeuronLiveLinkBPLibrary, 1650607968);
