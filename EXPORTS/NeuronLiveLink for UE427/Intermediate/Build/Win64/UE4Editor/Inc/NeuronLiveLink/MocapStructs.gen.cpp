...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_NeuronLiveLink_EMCCommandParamName_Hash() { return 2451161259U; }
...
static struct FScriptStruct_NeuronLiveLink_StaticRegisterNativesFMocapServerCommand
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMocapServerCommand>(FName(TEXT("MocapServerCommand")));
	}
...
static struct FScriptStruct_NeuronLiveLink_StaticRegisterNativesFMocapAvatar
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMocapAvatar>(FName(TEXT("MocapAvatar")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FMocapAvatar_Hash() { return 2430712456U; }
...
static struct FScriptStruct_NeuronLiveLink_StaticRegisterNativesFMocapTracker
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMocapTracker>(FName(TEXT("MocapTracker")));
	}
...
static struct FScriptStruct_NeuronLiveLink_StaticRegisterNativesFMocapRigidBody
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMocapRigidBody>(FName(TEXT("MocapRigidBody")));
	}
...
static struct FScriptStruct_NeuronLiveLink_StaticRegisterNativesFMCRenderSetting
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMCRenderSetting>(FName(TEXT("MCRenderSetting")));
	}
...
static struct FScriptStruct_NeuronLiveLink_StaticRegisterNativesFMCAppSettings
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMCAppSettings>(FName(TEXT("MCAppSettings")));
	}
	...
	IMPLEMENT_CLASS(UMocapApp, 1750733356);
