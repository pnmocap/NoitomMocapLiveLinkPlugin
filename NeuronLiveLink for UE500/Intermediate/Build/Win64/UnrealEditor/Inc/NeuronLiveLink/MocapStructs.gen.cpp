...
template<> NEURONLIVELINK_API UScriptStruct* StaticStruct<FMocapServerCommand>()
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMocapApp_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UMocapApp_GetLastErrorMessage, "GetLastErrorMessage" }, // 2016507298
		...
		{ &Z_Construct_UFunction_UMocapApp_QueueMocapCommand, "QueueMocapCommand" }, // 3689250408
	};
#if WITH_METADATA
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_NeuronLiveLink_Source_NeuronLiveLink_Public_MocapStructs_h_Statics::EnumInfo[] = {
		...
		{ EMCCommandParamName_StaticEnum, TEXT("EMCCommandParamName"), &Z_Registration_Info_UEnum_EMCCommandParamName, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3378777036U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_NeuronLiveLink_Source_NeuronLiveLink_Public_MocapStructs_h_Statics::ScriptStructInfo[] = {
		...
		{ FMocapAvatar::StaticStruct, Z_Construct_UScriptStruct_FMocapAvatar_Statics::NewStructOps, TEXT("MocapAvatar"), &Z_Registration_Info_UScriptStruct_MocapAvatar, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMocapAvatar), 1968009023U) },
		{ FMocapServerCommand::StaticStruct, Z_Construct_UScriptStruct_FMocapServerCommand_Statics::NewStructOps, TEXT("MocapServerCommand"), &Z_Registration_Info_UScriptStruct_MocapServerCommand, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMocapServerCommand), 3442469958U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_NeuronLiveLink_Source_NeuronLiveLink_Public_MocapStructs_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMocapApp, UMocapApp::StaticClass, TEXT("UMocapApp"), &Z_Registration_Info_UClass_UMocapApp, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMocapApp), 2017333742U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_NeuronLiveLink_Source_NeuronLiveLink_Public_MocapStructs_h_2515383454(TEXT("/Script/NeuronLiveLink"),
