...
// End Cross Module References
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_USubjectNameSetter_SetSubjectName_Statics::NewProp_Subject = { "Subject", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(SubjectNameSetter_eventSetSubjectName_Parms, Subject), Z_Construct_UScriptStruct_FLiveLinkSubjectName, METADATA_PARAMS(nullptr, 0) }; // 930695248
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_USubjectNameSetter_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_USubjectNameSetter_SetSubjectName, "SetSubjectName" }, // 1981125517
	};
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_NeuronLiveLink_Source_NeuronLiveLink_Public_SubjectNameSetter_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USubjectNameSetter, USubjectNameSetter::StaticClass, TEXT("USubjectNameSetter"), &Z_Registration_Info_UClass_USubjectNameSetter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USubjectNameSetter), 1121051377U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_NeuronLiveLink_Source_NeuronLiveLink_Public_SubjectNameSetter_h_2194665534(TEXT("/Script/NeuronLiveLink"),
